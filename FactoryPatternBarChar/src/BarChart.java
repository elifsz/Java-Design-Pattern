...
public class BarChart {
    ...
    /**
     *Font and image information is added for the bar according to the selected factory.
     * @param font the font of the bar
     * @param image the image of the bar
     */
    public void factoryAdd(String font, String image) {
        if (font == null) {
    ...
    public void draw() {
        ...
        for (int i = 0; i < names.size(); i++) {
            ...
            StdDraw.filledRectangle(0.5 * value, numberOfBars - i - 0.5, 0.5 * value, 0.3);

            StdDraw.setPenColor(StdDraw.BLACK);
            int fontSize = (int) Math.ceil(14 * 10.0 / numberOfBars);
            StdDraw.setFont(new Font(font, Font.BOLD, fontSize));
            StdDraw.textRight((value - 0.03 * xmax), numberOfBars - i - 0.5, name);

            StdDraw.picture(value - 0.01 * xmax, numberOfBars - i - 0.5, image);
